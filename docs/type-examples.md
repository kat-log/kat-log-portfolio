 ...
 * Webサイトプロジェクトの例
 */
export const projectDataExample: Project = {
  id: "portfolio-site",
  title: "ポートフォリオサイト",
  type: "website",
  ...
  screenshots: [
    {
      url: "/images/portfolio-desktop.png",
      alt: "ポートフォリオサイトのデスクトップ表示",
      caption: "トップページのヒーローセクション",
    },
    {
      url: "/images/portfolio-mobile.png",
      alt: "ポートフォリオサイトのモバイル表示",
      isMobile: true,
    },
  ],
  featured: true,
...
/**
 * Chrome拡張機能の例（シンプルな技術スタック）
 */
export const extensionExample: Project = {
  id: "tab-manager",
  title: "Tab Manager Pro",
  type: "extension",
  description: "効率的なタブ管理を実現するChrome拡張機能",
  tags: ["frontend", "opensource"],
  technologies: ["JavaScript", "Chrome API", "Webpack"], // シンプルな配列形式
  links: {
    github: "https://github.com/username/tab-manager",
    store: "https://chrome.google.com/webstore/detail/...",
  },
  screenshots: ["/images/tab-manager-1.png"], // シンプルな文字列配列
  date: "2024-11",
};
...
export const profileExample: Profile = {
  ...
  bio: "モダンなWeb技術を活用して、ユーザー体験を重視したアプリケーション開発を行っています。",
  longBio:
    "大学でコンピュータサイエンスを学び、フロントエンド開発の魅力に惹かれて...",
  ...
  skills: [
    ...
    { name: "Next.js", category: "framework", level: 4 },
    { name: "Tailwind CSS", category: "framework", level: 4 },
